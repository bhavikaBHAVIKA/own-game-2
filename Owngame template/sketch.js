...
if(level === 9)
{
    ...
    stroke("brown");
    fill("black");
    text("What was the name of second Peverell bother , who owned the Ressurection Stone ?", 250, 200);
    player.addImage(wand);
    player.x = mouseX;
    player.y = mouseY;
    ...
    textSize(20);
    fill("black");
    text("Antioch Peverell ",370,320);
    text("Cadmus Peverell",680,320);
    text(" Ignnotus Peverell ",980,320);
...
if(gameState === "end")
{
    ...
    textSize(35);
    fill("orange");
    text("NOW YOU ARE A CERTIFIED POTTERHEAD", 490,40);
}
